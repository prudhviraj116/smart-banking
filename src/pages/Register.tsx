    ...
    <div className="min-h-screen bg-banking-gradient flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-banking-gradient rounded-full mb-4">
            <Shield className="w-8 h-8 text-primary" />
          </div>
          <h1 className="text-3xl font-bold text-foreground mb-2">SecureBank</h1>
          <p className="text-primary-foreground/80">Join thousands of satisfied customers</p>
        </div>
